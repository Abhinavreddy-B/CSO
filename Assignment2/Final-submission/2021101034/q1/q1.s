...
func:               # main Function
    ...
    jl .invalid     # if n<1 go to line 44
    cmpq $100,%rdi  # compare 100 with n
    jg .invalid     # if n>100 go to line 44
    ...
    .loop:          # loop
        ...
        .loop2:                     # inner loop     
            ...
            je .NotThere            # if stack is empty go to line 30
            ...
            pushq %r10              # otherwise if t< x , push x back to the stack,
                                    # i.e invert the effect of line 20
...
.invalid:            # this section is for invalid input of n
    ret             # return
